...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bg_grad-06
      ...
      .row.mb-5.justify-center
        .col-12.col-md-9.col-lg-9
          LineaTiempoE.color-acento-botones.mb-3
            .row(titulo="GESTIÓN DE LAS EXISTENCIAS")
              .col-lg-12.mb-4.mb-lg-0
                p <b>LIFO:</b> último que entra es el primero que sale.  Habitualmente para productos que no tienen caducidad.
            .row
              .col-lg-12.mb-4.mb-lg-0
                p <b>FIFO:</b> primero que entra es el primero que sale. La mercancía con mayor  es la que primero debe salir.
            .row
              .col-lg-12.mb-4.mb-lg-0
    ...
    p La gestión de existencias es el área encargada de regular y optimizar los niveles de stock en la instalación. Para ello, se suelen utilizar <b>programas informáticos que hacen un seguimiento preciso de los movimientos de las existencias.</b>
    ...
    .row.mb-5.justify-center
      .col-12.col-md-5.bgr_20.p-5
        ...
        p.text-center.mb-0 los terminales de radiofrecuencia y otros sistemas, como el picking por voz y el <em>pick-to-light</em>, sirven de enlace entre el sistema informático y el mundo físico.
      .col-12.col-md-5.bgr_21.p-5
        ...
        p.text-center.mb-0 Este <em>software</em> organiza todas las operaciones de la instalación, junto con el ERP (<em>Enterprise Resource Planning</em>) de su empresa, que alberga la base de datos común. Los SGA pueden optimizar la asignación de ubicaciones, la organización de las operaciones de picking y los movimientos, entre otras acciones. También 
      ...
      .col-12.col-md-5.mb-3.mb-md-0
        div.justify-center
          .titulo-sexto.color-acento-contenido.mb-3  
              h5 Figura 3.
              span Stock mercancías
        figure.mb-5.justify-center
          img(src='@/assets/curso/tema3/t3-4.svg', alt='Texto que describa la imagen')
      .col-12.col-md-7.align-items-center
        div
          p La calidad y la eficiencia de la logística están totalmente vinculadas al stock de una empresa, ya que este sector representa más del 30% de los costos totales de una operación. Ajustar las cantidades que se almacenan entre los procesos de distribución es fundamental también para reducir los costes excesivos y no sólo facilitar los procedimientos en la cadena de entrega.
          .cajon.bgr_24.px-5.py-3
            .row  
              ...
              .col-12.col-md-9.align-items-center
                p.mb-0.text-bold El stock es un sector que exige mucha atención ya que sus costes tienen un gran impacto en los resultados financieros de una empresa aunque dependen directamente del nivel de ventas. 

    p.mb-5.text-bold Acciones para organizar stock de manera eficaz
    ...
    .cajon.bgr_25.px-5.py-3
      p Para ello, la gestión del inventario no debe realizarse por separado. Un buen stock no es más que el reflejo de una empresa organizada que se preocupa por el correcto almacenamiento de sus productos y el nivel de suministros que ofrece. 
      p.text-bold.mb-0 Organizar y gestionar el inventario de una empresa requiere tiempo y dedicación, pero es una tarea que efectivamente generará resultados empresariales.
